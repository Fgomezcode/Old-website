...
var resumeHTML = `
                  <div id="resumeLinks">
                  <a href="/RESUME PDF.pdf" download = "FelipeGomezVillalobosResume" target="_blank" >DOWNLOAD</a>
                  <a href="/RESUME PDF.pdf" target="_blank" >VIEW PDF</a>
                  </div>
                 <table>
                 <tr>
...
var contactHTML =
  "<p><center>Please email Felipe@FGomez.Dev with any questions.</center> </p>";
var projectHTML = `<ul>
                    <li><a href="Projects/Bladesmithing/smithing.html" target="blank"> BLADESMITHING</a></li>
                    <li><a href="Projects/Guitar/index.html" target="blank"> GUITAR SCALES</a></li>
                   </ul>`;
